...
For starter, you can use copy paste the Cypher script at https://github.com/Zenika/ziem-graphanalysis/tree/main/neo4j in your neo4j browser to populate your database with sample data.
